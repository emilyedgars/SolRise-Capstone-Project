...
const STATS = [
    { num: '10M+', label: 'Data Points Analysed', icon: '📊' },
...
const SERVICES = [
    { icon: '🔍', title: 'SEO Optimisation',     desc: 'Rank higher on Google with data-driven keyword strategy and technical SEO.' },
    { icon: '🤖', title: 'GEO (AI Search)',       desc: 'Get cited by ChatGPT, Perplexity & Google AI Overviews.' },
    { icon: '🎯', title: 'Competitor Intel',      desc: 'Know exactly what your competitors rank for and how to beat them.' },
    { icon: '⚡', title: 'AI Website Generation', desc: 'Generate fully optimised, schema-rich websites from your analysis.' },
];
...
const HomePage = ({ setActiveTab }) => {
    ...
    return (
        <main style={{ fontFamily: SR.font, background: SR.bg }}>
            ...
            <section style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        ✦ AI-Powered SEO & GEO Intelligence
                    </div>
                    ...
                    <p style={{
                        ...
                        We use AI, web scraping & advanced analytics to put your business
                        in front of the right people — on Google <em>and</em> in AI answers.
                    </p>
                    ...
                    <div style={{
                        ...
                        <button onClick={() => setActiveTab('quiz')} style={btnPrimary}>
                            Get Free Analysis →
                        </button>
                        <button onClick={() => setActiveTab('services')} style={btnOutline}>
                            See How It Works
                        </button>
                    </div>
                ...
                <div style={{
                    ...
                    {STATS.map((s, i) => (
                        <div key={i} style={{
                            ...
                            borderRadius: SR.lg, background: SR.lightGray,
                            border: SR.border,
                        }}>
            ...
            {/* ── Services Preview ─────────────────────────────────── */}
            <section style={{ background: SR.bg, padding: '5rem 2rem' }}>
                    ...
                    <div style={{
                        ...
                        {SERVICES.map((s, i) => (
                            <div key={i} style={{
                                ...
                                borderRadius: SR.xl, border: `1px solid ${SR.border}`,
            ...
            {/* ── How It Works ─────────────────────────────────────── */}
            <section style={{ background: SR.white, padding: '5rem 2rem' }}>
                <div style={{ maxWidth: 900, margin: '0 auto' }}>
                    <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
                        ...
                        <p style={{ color: SR.gray, fontSize: '1rem' }}>Three simple steps to a stronger online presence.</p>
                    </div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                        {STEPS.map((s, i) => (
                            <div key={i} style={{
                                ...
                                background: SR.lightGray, borderRadius: SR.xl,
            ...
            {/* ── CTA Banner ───────────────────────────────────────── */}
            <section style={{ padding: '5rem 2rem', background: SR.bg }}>
                <div style={{
                    ...
                    <p style={{
                        ...
                        Answer 5 quick questions and we'll deliver a personalised<br />
                        SEO & GEO analysis straight to your inbox.
                    </p>
                    <button
