...
const VALUES = [
    ...
    { icon: '🔒', title: 'Radical Clarity',  desc: 'No black box. We explain everything in plain English so you always know what we\'re doing and why.' },
    { icon: '🧑‍💼', title: 'Humans in the Loop', desc: 'AI powers our tools, but professionals are always involved. Our marketing analysts review every output to ensure quality, accuracy, and strategic fit.' },
];
