...
const STEPS = [
    ...
    },
    {
        ...
        options: [
            ...
            { value: 'geo',    icon: '🤖', title: 'Appear in AI Answers',    desc: 'Get cited by ChatGPT, Gemini, Claude, Copilot & Perplexity' },
    ...
    },
    {
        ...
        subtitle: 'Your personalised AI analysis is generated immediately.',
        type: 'contact',
        fields: [
        ...
        <div style={{
            ...
            <div style={{
                ...
                <p style={{
                    ...
                    Your personalised SEO & GEO report is ready immediately.
                </p>
