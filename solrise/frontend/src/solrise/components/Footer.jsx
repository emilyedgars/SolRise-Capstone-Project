...
const Footer = ({ setActiveTab }) => (
    <footer style={{
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
            ...
            {/* Main grid — fixed 4 equal columns, all aligned to top */}
            <div style={{
                display: 'grid',
                ...
                <div>
                    <p style={{
                        color: SR.white, fontWeight: 800, fontSize: '1.35rem',
                    ...
                    <p style={{
                        ...
                        lineHeight: 1.7, margin: '0 0 1.25rem', maxWidth: 220,
                    }}>
                ...
                <div>
                    <h4 style={{
                        color: SR.white, fontWeight: 700, fontSize: '0.9rem',
                ...
                <div style={{
                    ...
                    <p style={{ color: SR.white, fontWeight: 700, fontSize: '1rem', margin: '0 0 0.5rem' }}>
                        Ready to rise?
                    </p>
                    <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.85rem', lineHeight: 1.6, margin: '0 0 1rem' }}>
                        Get your free AI-powered SEO & GEO report.
                    </p>
                    <a
                        href="mailto:support@solrise.ai"
                        style={{
                            display: 'inline-block',
                            background: SR.btnGradient,
                            color: SR.white, textDecoration: 'none',
            ...
            <div style={{
                ...
                <p style={{ color: 'rgba(255,255,255,0.35)', fontSize: '0.8rem', margin: 0 }}>
                    © 2026 SolRise. All rights reserved.
                </p>
                <p style={{ color: 'rgba(255,255,255,0.35)', fontSize: '0.8rem', margin: 0 }}>
